...
public class CustomBeholsterLaserBehavior : BasicAttackBehavior
{
	...
	public void StartFiringTheLaser()
	{
		...
		if (DefualtDirection == true)
        {
			this.m_aiActor.aiAnimator.FacingDirection = (float)((this.m_aiActor.aiAnimator.FacingDirection <= 0f || this.m_aiActor.aiAnimator.FacingDirection >= 180f) ? -90 : 90);
		}
